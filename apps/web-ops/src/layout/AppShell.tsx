...
const NAV_GROUPS: { id: string; label: string; items: NavItem[] }[] = [
  {
    ...
    items: [
      ...
      { to: "/repairs", label: "Jobs", short: "Jobs", roles: ["owner", "manager", "technician", "cashier"] },
      { to: "/customers", label: "Customers", short: "Clients", roles: ["owner", "manager", "technician", "cashier"] },
      { to: "/notifications", label: "Inbox", short: "Inbox", roles: [] },
    ],
  },
  {
    id: "counter",
    ...
    items: [
      ...
      { to: "/counter/fix", label: "Same-day fix", short: "Fix", roles: ["owner", "manager", "cashier", "technician"] },
      { to: "/counter/pickup", label: "Pickup", short: "Pickup", roles: ["owner", "manager", "cashier"] },
    ],
  },
  {
    id: "money",
  ...
  },
  {
    ...
    items: [
      ...
      { to: "/trash", label: "Trashed", short: "Trash", roles: ["owner", "manager"] },
    ],
  },
];
