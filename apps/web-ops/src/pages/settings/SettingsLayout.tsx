...
const GROUPS: Array<{ label: string; items: SettingsNavItem[] }> = [
  ...
  },
  {
    ...
    items: [
      ...
      {
        to: "/settings/intake-presets",
        label: "Intake presets",
        icon: <Icon d="M9 5H7a2 2 0 0 0-2 2v12a2 2 0 0 0 2 2h10a2 2 0 0 0 2-2V7a2 2 0 0 0-2-2h-2" extra={<path d="M9 5a2 2 0 0 1 2-2h2a2 2 0 0 1 2 2v0a2 2 0 0 1-2 2h-2a2 2 0 0 1-2-2zM9 12h6M9 16h4" />} />,
      },
      {
        to: "/settings/shop",
        label: "Shop & tax",
